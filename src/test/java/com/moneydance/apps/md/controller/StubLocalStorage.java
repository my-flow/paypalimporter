...
public final class StubLocalStorage extends LocalStorage {
    ...
    @Override
    public boolean delete(final String arg0) throws Exception {
        return true;
    }

    @Override
    public boolean exists(final String arg0) throws Exception {
        return true;
    }

    @Override
    public boolean isFolder(final String arg0) throws Exception {
        return false;
    }
    ...
    @Override
    public InputStream openFileForReading(final String arg0) throws Exception {
        return null;
    }

    @Override
    public OutputStream openFileForWriting(final String arg0) throws Exception {
        return null;
    }
