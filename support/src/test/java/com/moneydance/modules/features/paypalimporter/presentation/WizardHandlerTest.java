...
public final class WizardHandlerTest {
    ...
    private static final String STUB_COMMAND = "STUB_COMMAND";
    ...
    public void testActionPerformed() {
        this.wizardHandler.actionPerformed(
                new ActionEvent(new Object(), 0, STUB_COMMAND));
        this.wizardHandler.actionPerformed(
                new ActionEvent(this.wizardHandler.btnHelp, 0, STUB_COMMAND));
        this.wizardHandler.actionPerformed(
                new ActionEvent(this.wizardHandler.btnProceed, 0, STUB_COMMAND));
        this.wizardHandler.actionPerformed(
                new ActionEvent(this.wizardHandler.btnCancel, 0, STUB_COMMAND));
    }
